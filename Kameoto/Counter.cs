...
namespace Kameoto
{
    ...
    {
        private long GetNowHiPerformanceCount()
        {
            // Stopwatch.GetTimestamp() はシステム依存のtickを返すため、マイクロ秒に変換する。
            return (long)(Stopwatch.GetTimestamp() * 1_000_000L / (double)Stopwatch.Frequency);
        }
        /// <summary>
        /// カウンターを初期化します。
        /// </summary>
        ...
        public long Tick()
        {
            // 何Tickしたかのカウント
            var tickCount = 0;
            var nowTime = GetNowHiPerformanceCount();
